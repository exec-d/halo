...
abstract class AppLocalizations {
  ...
  /// No description provided for @wallpaperHorizonTitle.
  ///
  /// In fr, this message translates to:
  /// **'Horizon'**
  String get wallpaperHorizonTitle;

  /// No description provided for @wallpaperHorizonDescription.
  ///
  /// In fr, this message translates to:
  /// **'Un horizon néon qui suit l\'heure et la vraie météo du lieu choisi.'**
  String get wallpaperHorizonDescription;

  /// No description provided for @wallpaperHorizonDayTitle.
  ///
  /// In fr, this message translates to:
  /// **'La journée'**
  String get wallpaperHorizonDayTitle;

  /// No description provided for @wallpaperHorizonDayText.
  ///
  /// In fr, this message translates to:
  /// **'Le soleil se lève, traverse le ciel et se couche aux vraies heures ; la nuit, la lune dans sa phase et les étoiles.'**
  String get wallpaperHorizonDayText;

  /// No description provided for @wallpaperHorizonWeatherTitle.
  ///
  /// In fr, this message translates to:
  /// **'La météo'**
  String get wallpaperHorizonWeatherTitle;

  /// No description provided for @wallpaperHorizonWeatherText.
  ///
  /// In fr, this message translates to:
  /// **'Nuages, pluie, neige, orage ou brume, selon le temps qu\'il fait au lieu choisi dans Météo.'**
  String get wallpaperHorizonWeatherText;

  /// No description provided for @wallpaperHorizonTiltTitle.
  ///
  /// In fr, this message translates to:
  /// **'Inclinaison'**
  String get wallpaperHorizonTiltTitle;

  /// No description provided for @wallpaperHorizonTiltText.
  ///
  /// In fr, this message translates to:
  /// **'Montagnes et sol quadrillé glissent quand vous penchez le téléphone.'**
  String get wallpaperHorizonTiltText;

  /// No description provided for @wallpaperHorizonBattery.
  ///
  /// In fr, this message translates to:
  /// **'L\'animation s\'arrête dès que le fond n\'est plus visible ; elle ralentit par temps clair, et ne va vite que sous la pluie ou la neige.'**
  String get wallpaperHorizonBattery;

  /// No description provided for @wallpaperSkyTitle.
  ///
  /// In fr, this message translates to:
  /// **'Ciel'**
  String get wallpaperSkyTitle;

  /// No description provided for @wallpaperSkyDescription.
  ///
  /// In fr, this message translates to:
  /// **'Les vraies étoiles et la vraie Lune au-dessus de vous, dans la direction du téléphone.'**
  String get wallpaperSkyDescription;

  /// No description provided for @wallpaperSkyRealTitle.
  ///
  /// In fr, this message translates to:
  /// **'Le vrai ciel'**
  String get wallpaperSkyRealTitle;

  /// No description provided for @wallpaperSkyRealText.
  ///
  /// In fr, this message translates to:
  /// **'Les étoiles les plus brillantes et les constellations, à leur place pour le lieu choisi dans Météo et pour cette heure.'**
  String get wallpaperSkyRealText;

  /// No description provided for @wallpaperSkyCompassTitle.
  ///
  /// In fr, this message translates to:
  /// **'Boussole'**
  String get wallpaperSkyCompassTitle;

  /// No description provided for @wallpaperSkyCompassText.
  ///
  /// In fr, this message translates to:
  /// **'Tournez-vous : le ciel suit la direction du téléphone. Levez-le : vous montez vers le zénith.'**
  String get wallpaperSkyCompassText;

  /// No description provided for @wallpaperSkyDayTitle.
  ///
  /// In fr, this message translates to:
  /// **'Le jour'**
  String get wallpaperSkyDayTitle;

  /// No description provided for @wallpaperSkyDayText.
  ///
  /// In fr, this message translates to:
  /// **'Le ciel s\'éclaircit et les étoiles pâlissent quand le soleil est levé.'**
  String get wallpaperSkyDayText;

  /// No description provided for @wallpaperSkyBattery.
  ///
  /// In fr, this message translates to:
  /// **'L\'animation et la boussole s\'arrêtent dès que le fond n\'est plus visible.'**
